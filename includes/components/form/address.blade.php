 <div class="form-group">
	{{ Form::label($name,  trans('table.'.$name), ['class' => 'sr-only']) }}
	<div class="form-group">
		<input type="text" name="address" id="autocomplete" class="form-control form-control-lg search-input col-md-6" placeholder="Enter your address" required></input>
 	</div>
</div>
